create table attachments (id int8 generated by default as identity, created_date timestamp not null, name varchar(255) not null, idea_id int8 not null, primary key (id));
