create table attachments (id int8 generated by default as identity, name varchar(255) not null, idea_id int8 not null, primary key (id));
...
create table ideas (id int8 generated by default as identity, created_date timestamp not null, name varchar(255) not null, text varchar(255) not null, contact_id int8 not null, created_by_id int8 not null, status_id int8 not null, primary key (id));
...
create table votes (id int8 generated by default as identity, created_date timestamp not null, option_answer int2 not null, created_by_id int8 not null, voting_id int8 not null, primary key (id));
create table voting (id int8 generated by default as identity, created_date timestamp not null, created_by_id int8 not null, idea_id int8 not null, status_id int8 not null, primary key (id));
...
alter table if exists attachments add constraint FKgeq5upm8jljclu9759wfrxkuc foreign key (idea_id) references ideas;
